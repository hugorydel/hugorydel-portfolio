		...
		<>
			{home && (
				<Container
					...
					disableGutters
					maxWidth={false}>
					<div className={layoutStyle.cubeGrid}>
						<div className={`${layoutStyle.cube1} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube2} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube3} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube4} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube5} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube6} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube7} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube8} ${layoutStyle.cube}`}></div>
						<div className={`${layoutStyle.cube9} ${layoutStyle.cube}`}></div>
					</div>
				</Container>
			)}
